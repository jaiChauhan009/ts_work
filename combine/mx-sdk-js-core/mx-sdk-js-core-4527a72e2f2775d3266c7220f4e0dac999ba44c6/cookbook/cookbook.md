...
A full list of available methods for `ApiNetworkProvider` can be found [here](https://TerraDhritri.github.io/drt-sdk-js-core/v14/classes/ApiNetworkProvider.html).

Both `ApiNetworkProvider` and `ProxyNetworkProvider` implement a common interface, which can be found [here](https://TerraDhritri.github.io/drt-sdk-js-core/v14/interfaces/INetworkProvider.html). This allows them to be used interchangeably.
...
:::tip
When creating transactions using [`SmartContractController`](https://TerraDhritri.github.io/drt-sdk-js-core/v14/classes/SmartContractController.html) or [`SmartContractTransactionsFactory`](https://TerraDhritri.github.io/drt-sdk-js-core/v14/classes/SmartContractTransactionsFactory.html), even if the ABI is available and provided,
you can still use [`TypedValue`](https://TerraDhritri.github.io/drt-sdk-js-core/v14/classes/TypedValue.html) objects as arguments for deployments and interactions.

Even further, you can use a mix of [`TypedValue`](https://TerraDhritri.github.io/drt-sdk-js-core/v14/classes/TypedValue.html) objects and plain JavaScript values and objects. For example:
...
- [TokenManagementController](https://TerraDhritri.github.io/drt-sdk-js-core/v14/classes/TokenManagementController.html)
- [TokenManagementTransactionsFactory](https://TerraDhritri.github.io/drt-sdk-js-core/v14/classes/TokenManagementTransactionsFactory.html)
...
- [DelegationController](https://TerraDhritri.github.io/drt-sdk-js-core/v14/classes/DelegationController.html)
- [DelegationTransactionsFactory](https://TerraDhritri.github.io/drt-sdk-js-core/v14/classes/DelegationTransactionsFactory.html)
...
Then, on the receiving side, you can use [`MessageComputer.unpackMessage()`](https://TerraDhritri.github.io/drt-sdk-js-core/v14/classes/MessageComputer.html#unpackMessage) to reconstruct the message, prior verification:
