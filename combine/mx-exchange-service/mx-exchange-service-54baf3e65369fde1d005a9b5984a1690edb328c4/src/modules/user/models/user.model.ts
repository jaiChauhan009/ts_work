...
import { LockedDcdtToken } from 'src/modules/tokens/models/lockedDcdtToken.model';
...
@ObjectType()
export class UserToken extends DcdtToken {
...
@ObjectType()
export class UserLockedDcdtToken extends LockedDcdtToken {
    @Field() valueUSD: string;

    constructor(init?: Partial<UserLockedDcdtToken>) {
        super(init);
        Object.assign(this, init);
    }
}
...
@ObjectType()
export class UserLockedTokenEnergy extends LockedDcdtToken {
    @Field() valueUSD: string;
