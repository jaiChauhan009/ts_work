use dharitri_sc::api::{ED25519_SIGNATURE_BYTE_LEN, KECCAK256_RESULT_LEN};

use crate::constants::{Proof, WeightedSigners, DHARITRI_SIGNED_MESSAGE_PREFIX};
use crate::events;
...
pub trait AuthModule: events::Events {
    ...
    fn message_hash_to_sign(
        ...
        encoded.append(&ManagedBuffer::from(DHARITRI_SIGNED_MESSAGE_PREFIX));
