...
describe("test smart contract transactions factory", function () {
    ...
    it("should create 'Transaction' for execute and transfer with EGLD as single token tranfer", async function () {
        ...
        assert.deepEqual(
            transaction.data,
            Buffer.from(
                "MultiDCDTNFTTransfer@00000000000000000500b9353fe8407f87310c87e12fa1ac807f0485da39d152@01@45474c442d303030303030@@0a@616464@07",
            ),
        );
        assert.equal(transaction.gasLimit, gasLimit);
        assert.equal(transaction.value, 0n);
    ...
    it("should create 'Transaction' for execute and transfer native and nfts", async function () {
        ...
        assert.deepEqual(
            transaction.data,
            Buffer.from(
                "MultiDCDTNFTTransfer@00000000000000000500b9353fe8407f87310c87e12fa1ac807f0485da39d152@03@4e46542d313233343536@01@01@4e46542d313233343536@2a@01@45474c442d303030303030@@0de0b6b3a7640000@616464@07",
            ),
        );
