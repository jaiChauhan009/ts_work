...
describe('Collections e2e tests with chain simulator', () => {
  describe('GET /collections', () => {
    ...
    it('should filter by type', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/collections?type=NonFungibleDCDT`);
      expect(response.status).toBe(200);
      expect(response.data.every((collection: any) => collection.type === 'NonFungibleDCDT')).toBe(true);
    });

    it('should exclude MetaDCDT collections when specified', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/collections?excludeMetaDCDT=true`);
      expect(response.status).toBe(200);
      expect(response.data.every((collection: any) => collection.type !== 'MetaDCDT')).toBe(true);
    });
  ...
  describe('GET /collections/count', () => {
    ...
    it('should return filtered collection count by type', async () => {
      const type = NftType.NonFungibleDCDT;
  ...
  describe('GET /collections/:collections/nfts', () => {
    it('should return all nfts for a collection', async () => {
      const collectionsIdentifiers = await axios.get(`${config.apiServiceUrl}/collections?size=1&type=NonFungibleDCDT`);
      const collection = collectionsIdentifiers.data.map((collection: any) => collection.collection);
    ...
    it('should return nfts by identifiers', async () => {
      const collectionsIdentifiers = await axios.get(`${config.apiServiceUrl}/collections?size=2&type=NonFungibleDCDT`);
      const collection = collectionsIdentifiers.data.map((collection: any) => collection.collection);
    ...
    it('should return nfts with withOwner', async () => {
      ...
      expect(response.data.every((nft: any) => nft.type === NftType.NonFungibleDCDT)).toBe(true);
    });

    it('should return nfts with withSupply', async () => {
      const collectionsIdentifiers = await axios.get(`${config.apiServiceUrl}/collections?size=1&type=SemiFungibleDCDT`);
      const collection = collectionsIdentifiers.data.map((collection: any) => collection.collection);
      ...
      expect(response.data.every((nft: any) => nft.type === NftType.SemiFungibleDCDT)).toBe(true);
    });
  });
  ...
  describe('GET /collections/:collection/nfts/count', () => {
    ...
    it('should return nfts count for a collection with identifiers', async () => {
      const collectionsIdentifiers = await axios
        .get(`${config.apiServiceUrl}/collections?size=1&type=NonFungibleDCDT`);
  ...
  describe('GET /collections/:collection/transactions', () => {
    it('should return transactions for a collection of type NFT', async () => {
      const collectionNFT = await axios.get(`${config.apiServiceUrl}/collections?size=1&type=NonFungibleDCDT`);
    ...
    it('should return transactions for a collection of type SFT', async () => {
      const collectionSFT = await axios.get(`${config.apiServiceUrl}/collections?size=1&type=SemiFungibleDCDT`);
    ...
    it('should return transactions for a collection of type MetaDCDT', async () => {
      const collectionMetaDCDT = await axios.get(`${config.apiServiceUrl}/collections?size=1&type=MetaDCDT`);
      const collectionMetaDCDTDetails = collectionMetaDCDT.data.map((collection: any) => collection.collection);

      const response = await axios.get(`${config.apiServiceUrl}/collections/${collectionMetaDCDTDetails[0]}/transactions`);
    ...
    it('should return transactions for a collection of type NFT with a specific function', async () => {
      ...
      const response = await axios.get(`${config.apiServiceUrl}/collections/${collectionNFTDetails[0]}/transactions?function=DCDTNFTCreate`);
  ...
  describe('GET /collections/:collection/transfers', () => {
    ...
    it('should return transfers for a collection of type MetaDCDT', async () => {
      ...
      const response = await axios.get(`${config.apiServiceUrl}/collections/${collectionMetaDCDTDetails[0]}/transfers`);
    ...
    it('should return transfers for a collection of type NFT with a specific function', async () => {
      ...
      const response = await axios.get(`${config.apiServiceUrl}/collections/${collectionNFTDetails[0]}/transfers?function=DCDTNFTCreate`);
